                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {[
                            ...
                            { icon: Phone, value: "50K+", label: "Calls Handled", color: "bg-orange-600" },
            ...
            <section className="py-20 px-4 bg-gradient-to-br from-blue-600 to-purple-600">
                <div className="max-w-4xl mx-auto text-center text-white">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">
                        Ready to Join the Beauty Drop AI Family?
                    </h2>
                    <p className="text-xl text-blue-100 mb-8">
                        Let's transform your salon together. Get started in minutes with our easy setup process.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/contact">
                            <Button className="h-14 px-8 bg-white hover:bg-gray-100 text-blue-600 text-lg font-bold rounded-xl shadow-lg flex items-center gap-2">
                                <Calendar className="w-5 h-5" />
                                Schedule a Demo
                            </Button>
                        </Link>
                        <Link href="/pricing">
                            <Button variant="outline" className="h-14 px-8 bg-transparent hover:bg-white/10 text-white text-lg font-semibold rounded-xl border-2 border-white flex items-center gap-2">
                                View Plans
                                <ArrowRight className="w-5 h-5" />
                            </Button>
                        </Link>
