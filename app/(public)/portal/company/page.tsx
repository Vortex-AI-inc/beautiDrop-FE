                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href="/portal/staff" className="text-sm font-medium text-blue-600 hover:text-blue-700 flex items-center gap-1">
                                <Users className="w-4 h-4" /> Manage Staff
                            </Link>
                            <Link href="/portal/services" className="text-sm font-medium text-blue-600 hover:text-blue-700 flex items-center gap-1">
