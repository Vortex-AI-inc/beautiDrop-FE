    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <Link href="/" className="flex items-center justify-center gap-2">
          ...
          <span className="font-heading font-bold text-xl text-primary">BeautyDrop AI</span>
        </Link>
        ...
        <div className="bg-card text-card-foreground rounded-lg border border-border shadow-sm p-6 space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="font-sans text-base leading-relaxed text-muted-foreground">Sign in to your salon account</p>
          </div>
